...
export default function SportsBettingScreen({ navigation }) {
  ...
  // Ends through the session-end transition rather than navigating here: the
  // wash covers the screen, moves to History underneath it, then commits. The
  // pending-bet guard above still runs first.
