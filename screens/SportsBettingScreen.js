...
const styles = StyleSheet.create({
  ...
  netAmount: { fontSize: 34, fontWeight: '700', marginBottom: 14 },
  ...
  payoutPreviewValue: { fontSize: 20, fontWeight: '700', color: COLORS.success, marginTop: 2 },
  favDogBadge: {
    paddingHorizontal: 7,
    paddingVertical: 2,
    borderRadius: 6,
  },
  favDogBadgeText: { fontSize: 9, fontWeight: '700', letterSpacing: 0.4 },
  ...
  liveBadgeText: { fontSize: 9, fontWeight: '700', color: COLORS.warning, letterSpacing: 0.4 },
