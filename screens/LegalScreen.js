...
const TERMS_SECTIONS = [
  ...
  {
    heading: '7. Ante Pro subscriptions and payments',
    body: [
      'Ante is free to download and use. Certain features are grouped into an optional paid subscription called Ante Pro.',
    ],
    bullets: [
      'Billing. Ante Pro is sold as an in-app purchase through the Apple App Store or Google Play. Payment is charged to your App Store or Google Play account when you confirm the purchase. We do not process payments directly and never receive your payment card details.',
      'Auto-renewal. Recurring Ante Pro plans renew automatically at the end of each billing period at the then-current price, unless you cancel at least 24 hours before the current period ends. A one-time or lifetime purchase, where offered, does not renew.',
      ...
      'Price and plan changes. We may change subscription prices or the set of features included in Ante Pro. A price change to an existing recurring subscription will be notified in advance as required by the app store and takes effect at your next renewal; you may cancel before then.',
      ...
      'What happens when Pro ends. If your subscription lapses or is cancelled, Pro-only features become unavailable, but the session and hand data you recorded remains and stays accessible.',
